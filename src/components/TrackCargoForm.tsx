            ...
            <div className="relative flex flex-col justify-center items-center mx-auto w-full max-w-3xl shadow-lg rounded-lg bg-white p-4">
                <form className='w-full'>
                    ...
                    <div className="relative">
                        ...
                        <input type="search" id="search" className="block w-full h-16 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full md:rounded-lg bg-gray-50 focus:ring-dark focus:border-dark" placeholder="Search" required />
                        <button type="submit" className="text-white absolute right-1.5 top-1.5 bg-dark hover:bg-opacity-95 focus:ring-4 focus:outline-none focus:ring-dark3 font-medium rounded-full md:rounded-lg text-sm px-6 py-4 dark:bg-dark dark:hover:bg-dark dark:focus:ring-dark">Track Now</button>
                    </div>
                </form>
